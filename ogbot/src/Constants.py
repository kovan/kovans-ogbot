...
INGAME_TYPES = [
    Ship('smallCargo'                       , 'ship202' , Resources(2000    , 2000    , 0)        , 5000    , 20)   , 
    Ship('largeCargo'                       , 'ship203' , Resources(6000    , 6000    , 0)        , 25000   , 50)   , 
    Ship('lightFighter'                     , 'ship204' , Resources(3000    , 1000    , 0)        , 50      , 20)   , 
    Ship('heavyFighter'                     , 'ship205' , Resources(6000    , 4000    , 0)        , 100     , 75)   , 
    Ship('cruiser'                          , 'ship206' , Resources(20000   , 7000    , 2000)     , 800     , 300)  , 
    Ship('battleShip'                       , 'ship207' , Resources(45000   , 15000   , 0)        , 1500     , 500)  , 
    Ship('colonyShip'                       , 'ship208' , Resources(10000   , 20000   , 10000)    , 7500    , 1000) , 
    Ship('recycler'                         , 'ship209' , Resources(10000   , 6000    , 2000)     , 20000   , 300)  , 
    Ship('espionageProbe'                   , 'ship210' , Resources(0       , 1000    , 0)        , 1       , 1)    , 
    Ship('bomber'                           , 'ship211' , Resources(500     , 50000   , 25000)    , 15000   , 1000) , 
    Ship('solarSatellite'                   , 'ship212' , Resources(0       , 2000    , 500)      , 0       , 0)    , 
    Ship('destroyer'                        , 'ship213' , Resources(60000   , 50000   , 15000)    , 2000    , 1000) , 
    Ship('deathStar'                        , 'ship214' , Resources(5000000 , 4000000 , 1000000)  , 1000000 , 1)    , 
    Ship('battlecruiser'                    , 'ship215' , Resources(30000   , 40000   , 15000)    , 750     , 250)  ,
